...
We are now at the last part of step by step guide on how to simulate STM32 project in Proteus.
 ...
 14. After creation of the circuit as per requirement as shown below , Double click on the the MCU part to open settings. Next to the Program File option, give full path to the Hex file generated using STM32Cube IDE. Then set the external crystal frequency to 8M (i.e. 8 MHz). Click OK to save the changes.
